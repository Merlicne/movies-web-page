<div class="navbar">
    ...
    <ul class="nav">
        ...
        <li>
            {{-- <form ac   class="search-bar relative text-gray-600"> --}}
            <form action="{{route('search')}}" method="GET" class="search-bar relative text-gray-600">
                <input type="search" name="query" placeholder="Search"
                    class="search-input bg-white h-10 px-5 pr-10 rounded-full text-sm focus:outline-none shadow-md">
